...
export const BuscadorMegaDrive = () => {
  ...
  return (
    ...
    <div
      className={`buscador-megadrive-wrapper container mt-4 relative ${mostrarEfecto ? "efecto-entrada-sega" : ""
        }`}
    >
      ...
      {mostrarEfecto && listo && <div className="overlay-megadrive"></div>}
            ...
            <div className="video-card">
              ...
              <div className="video-container">
                <iframe
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/VgYHno4PPO4?si=jLqjktnF1AcYJy0a"
            ...
            <div className="video-card">
              ...
              <div className="video-container">
                <iframe
                  width="560"
                  height="315"
                  src="https://www.youtube.com/embed/jpdARMtEmqY?si=fGJW2qQ88FXHi5NH"
                  title="YouTube video player"
                  frameBorder="0"
                  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                  referrerPolicy="strict-origin-when-cross-origin"
          ...
          {!cargando &&
            ...
            busqueda.trim() !== "" && (
              <p className="texto-error">
                ❌ No existen juegos de Mega Drive con ese nombre.
              </p>
            )}
        </>
      )}
